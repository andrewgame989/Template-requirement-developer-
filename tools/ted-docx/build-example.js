...
const doc = new Document({
  ...
  title: "Contoh TED #21742 - Screen Whitelist MAAS",
  description: "Contoh pengisian TED memakai template terbaru - kasus Screen Whitelist MAAS",
  styles: {
    default: {
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync("Contoh-TED-21742.docx", buf);
